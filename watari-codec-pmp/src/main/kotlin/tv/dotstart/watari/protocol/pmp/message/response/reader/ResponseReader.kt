 ...
 */
package tv.dotstart.watari.protocol.pmp.message.response.reader
...
/**
 * Provides a reader for a specific type of response.
 *
 * @author Johannes Donath
 * @date 08/07/2022
 */
interface ResponseReader<out DM : Response> : MessageReader<DM, WireResponse>
