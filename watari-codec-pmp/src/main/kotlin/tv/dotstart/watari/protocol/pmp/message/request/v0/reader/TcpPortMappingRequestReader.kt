...
/**
 * Decodes TCP port mapping requests.
 *
 * @author Johannes Donath
 * @date 08/07/2022
 */
object TcpPortMappingRequestReader : AbstractPortMappingRequestReader<TcpPortMappingRequest>() {

  override val opcode: UByte
    get() = TcpPortMappingRequest.OPCODE
