...
/**
 * Encapsulates a response to a prior TCP port mapping request.
 *
 * @author Johannes Donath
 * @date 08/07/2022
 */
data class TcpPortMappingResponse(
  ...
  override val protocol = NetworkProtocol.TCP

  companion object {

    val OPCODE: UByte = (Response.BASE_OPCODE + 2u).toUByte()
  }
}
