 ...
 * @date 09/07/2022
 */
object ExternalAddressDiscoveryRequestWriter : RequestWriter<ExternalAddressDiscoveryRequest> {

  override val type = ExternalAddressDiscoveryRequest::class

  override fun encode(
    alloc: ByteBufAllocator,
    msg: ExternalAddressDiscoveryRequest
  ): WireRequest {
    val payload = alloc.buffer(0, 0)

    return WireRequest(
      msg.sender, msg.recipient,
      0u, ExternalAddressDiscoveryRequest.OPCODE, payload
    )
  }
}
