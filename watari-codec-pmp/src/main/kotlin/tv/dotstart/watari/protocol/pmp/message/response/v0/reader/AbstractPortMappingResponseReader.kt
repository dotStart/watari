...
/**
 * Provides a base for reader implementations which decode port mapping responses.
 *
 * @author Johannes Donath
 * @date 09/07/2022
 */
abstract class AbstractPortMappingResponseReader<out DM : PortMappingResponse> :
  ResponseReader<DM> {
  ...
  override fun decode(msg: WireResponse): DM {
    with(msg.content()) {
      ...
      val externalPort = readShort().toUShort()
      val timeToLive = readUnsignedInt()
