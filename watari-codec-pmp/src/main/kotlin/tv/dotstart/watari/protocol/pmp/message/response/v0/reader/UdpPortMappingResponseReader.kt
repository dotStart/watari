...
/**
 * Provides a reader for UDP port mapping responses.
 *
 * @author Johannes Donath
 * @date 09/07/2022
 */
object UdpPortMappingResponseReader : AbstractPortMappingResponseReader<UdpPortMappingResponse>() {

  override val opcode: UByte
    get() = UdpPortMappingResponse.OPCODE
